...
var timeoutUpdateAnnouncement = (1000 * 60) * 20;
...
function restart()
{
    ...
    setTimeout(function()
    {
      ws.send(createPacket("say NOTICE: Update detected! We're updating the server in <color=orange>20 minutes</color>"));
  		setTimeout(function()
  		{
